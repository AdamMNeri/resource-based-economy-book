...
# Ensure references.md exists in chapters/ and is copied to src/
references_file = "references.md"
if os.path.exists(os.path.join(src_dir, references_file)) and not os.path.exists(os.path.join(chapters_dir, references_file)):
    shutil.copy2(os.path.join(src_dir, references_file), os.path.join(chapters_dir, references_file))
elif os.path.exists(os.path.join(chapters_dir, references_file)) and not os.path.exists(os.path.join(src_dir, references_file)):
    shutil.copy2(os.path.join(chapters_dir, references_file), os.path.join(src_dir, references_file))
