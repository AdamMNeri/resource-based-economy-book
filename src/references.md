...
This document compiles the academic citations, institutional reports, and foundational literature cited throughout *Beyond Money: A UN Pathway to a Resource-Based Economy*.
...
* **Topics**: Polycrisis; failure of decoupling growth from material footprint; post-growth economics; institutional innovations (Mexico direct budgeting, Messina Foundation, Builders Vision Oceans Strategy).
* **Citations**: [8, 10, 11, 13, 14]
...
* **Topics**: Distributive justice models—Equality (equal shares), Equity (proportional to contribution), Need (based on necessity).
* **Citations**: [161-163]
...
* **Topics**: Central bank tools (interest rates, reserve limits, QE); Federal Reserve dual mandate; fiscal policy deficits and political distortions.
* **Citations**: [199, 201, 202, 206, 207]
...
* **Topics**: Expanded UN pathway paper; detailed roles for UNEP, UNCTAD, UN DESA, ITU; blockchain for resource accounting.
* **Citations**: [233-238]
...
* **Citations**: [268, 270, 281, 282, 287, 288]
...
* **Topics**: Classification of money (commodity, representative, fiat); bank money creation via fractional reserve lending.
* **Citations**: [326, 328, 329]
...
* **Topics**: 97% bank debt money creation; compound interest trap forcing exponential growth on a finite planet; public utility money.
* **Citations**: [379, 380, 383, 387, 388]
...
* **Topics**: Monetary policy transmission to inequality; asset price inflation disproportionately enriching top wealth deciles.
* **Citations**: [427, 430, 433, 438]
...
* **Topics**: Strategic power competition; non-military gray zone strategies; revisionist powers; need for rules-based international coordination.
* **Citations**: [456, 468, 511, 576, 584]
